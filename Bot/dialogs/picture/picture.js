...
// Picture.js defines the Picture dialog

// Import required Bot Builder
const { ComponentDialog, WaterfallDialog, TextPrompt } = require('botbuilder-dialogs');

// User state for Picture dialog
 ...
 */
class Picture extends ComponentDialog {
  constructor(dialogId, userProfileAccessor) {
    ...
    this.addDialog(new WaterfallDialog(PROFILE_DIALOG, [
      ...
      this.displayPictureStep.bind(this)
    ]));
  ...
  /**
   * Helper function to greet user with information in PictureState.
   *
   * @param {WaterfallStepContext} step contextual information for the current step being executed
   */
