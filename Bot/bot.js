...
const { FaceDialog } = require('./dialogs/face');
const { CheckTruckDialog } = require('./dialogs/checktruck');
const { JokeDialog } = require('./dialogs/joke');
const { PictureDialog } = require('./dialogs/picture');
const { PredictDialog } = require('./dialogs/predict');
...
const PICTURE_DIALOG = 'pictureDialog';

// State Accessor Properties
const DIALOG_STATE_PROPERTY = 'dialogState';
const USER_PROFILE_PROPERTY = 'userProfileProperty';
const CONNECTIONSTRING_PROPERTY = 'connectionStringProperty'

// LUIS service type entry as defined in the .bot file.
// const LUIS_CONFIGURATION = 'basic-bot-LUIS';
const LUIS_CONFIGURATION = 'LunchbellBot-LUIS';
...
const FACE_INTENT = 'CheckFace';
const CHECKTRUCK_INTENT = 'CheckForTruck';
const JOKE_INTENT = 'Joke';
const PREDICT_INTENT = 'PredictArrival';
const PICTURE_INTENT = 'TakePicture';
...
class LunchBellBot {
  ...
  constructor(conversationState, userState, botConfig, connectionString) {
    ...
    //this.connectionString = conversationState.createProperty(CONNECTIONSTRING_PROPERTY);
          ...
          case DialogTurnStatus.empty:
            ...
            switch (topIntent) {
              case GREETING_INTENT:
                ...
                break;
              case FACE_INTENT:
                await dc.beginDialog(FACE_DIALOG);
                break;
              case CHECKTRUCK_INTENT:
                await dc.beginDialog(CHECKTRUCK_DIALOG);
                break;
              case JOKE_INTENT:
                await dc.beginDialog(JOKE_DIALOG);
                break;
              case PREDICT_INTENT:
                await dc.beginDialog(PREDICT_DIALOG);
                break;
              case PICTURE_INTENT:
                await dc.beginDialog(PICTURE_DIALOG);
                break;
              case NONE_INTENT:
              default:
...
module.exports.LunchBellBot = LunchBellBot;